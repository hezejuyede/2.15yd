                ...
                <div class="account" v-show="right === true">
                    ...
                    <div class="loginIndex-selectWorkstation">
                        ...
                        <select
                          ...
                          <option value="1">切断</option>
                          <option value="2">短管焊</option>
                          <option value="3">直管焊</option>
                          <option value="4">弯管</option>
                          <option value="5">小组立</option>
                          <option value="6">弯头管</option>
                          <option value="7">43/48装配</option>
                          <option value="8">大阻焊</option>
                          <option value="9">45/46装配</option>
                          <option value="10">枝管切断</option>
                          <option value="11">弯头切断</option>
                        </select>
